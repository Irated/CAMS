...
<style>
    ...
    #btn{
        height: 3vw;width: 
        10vw;font-family: 'Courier New', Courier, monospace;
        font-weight: bolder;
        border-radius: 10px;
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;color: #fff">
    <div style="background-color: #042A38;height: auto;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            <section style="margin: 1.5vw;">ONLINE QUIZ SIMULATOR</section>
        ...
        $qid=$_GET["qid"];
            ...
            if(isset($_POST["submit"])){
                ...
                echo "<script>alert(\"You scored ".$score." marks out of ".$count." marks\");</script>";
...
"function dash(){".
    ...
    "}".
"function lo(){".
"alert(\"Thank You for Using our ONLINE QUIZ SIMULATOR\");";
